...
new=readfile("initconds_MM")    		   ## name of initconds file from amber_to_initconds.py
original=readfile("initconds_QM")    ## name of initconds file with wigner QM velocities
...
writefile("initconds_QMMM", outputstring)
